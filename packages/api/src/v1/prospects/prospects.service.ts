...
type ProspectStatus = 'NEW' | 'CONTACTED' | 'QUALIFIED' | 'AUDIT_SCHEDULED' | 'AUDIT_COMPLETE' | 'PROPOSAL_SENT' | 'WON' | 'LOST';
const PROSPECT_STATUSES: ProspectStatus[] = ['NEW', 'CONTACTED', 'QUALIFIED', 'AUDIT_SCHEDULED', 'AUDIT_COMPLETE', 'PROPOSAL_SENT', 'WON', 'LOST'];
