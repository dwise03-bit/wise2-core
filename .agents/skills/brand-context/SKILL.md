...
Check if `.agents/brand-context.md` already exists (or `.Codex/brand-context.md`). If it does, read it and ask the user what they'd like to update. If it doesn't exist, collect the information below.
