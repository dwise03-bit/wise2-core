...
- **AI-first schema:** Every note has structure for Codex retrieval (preambles, frontmatter, wikilinks)
...
**Pattern:** Command describes intent → Python script does deterministic work → Codex synthesizes output → Hooks validate writes
...
Already installed in `.Codex/skills/`:
