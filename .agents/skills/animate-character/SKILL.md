...
2. **Image attached / drag-and-dropped** — The user dragged an image file into Codex. The image is visible in the conversation but `$ARGUMENTS[0]` may not be a valid path. In this case:
