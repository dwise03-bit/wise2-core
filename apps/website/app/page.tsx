...
export default function Home() {
  ...
  const services = [
    ...
    },
    {
      ...
      icon: '📚',
      url: 'https://wise2.net:3010/api/docs',
    ...
    },
    {
      ...
      icon: '📡',
      url: 'https://studio.wise2.net/live-streaming',
