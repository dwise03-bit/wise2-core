...
android { namespace = "com.wise2.mecapture"; compileSdk = 35
    defaultConfig { applicationId = "com.wise2.mecapture"; minSdk = 26; targetSdk = 35; versionCode = 2; versionName = "1.1.0"; testInstrumentationRunner = "androidx.test.runner.AndroidJUnitRunner" }
