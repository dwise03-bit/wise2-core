...
/**
 * GET /api/suno/audio/[id]
 * Proxies generated audio from the MusicGen service (raw generation ID,
 * not the gen_-prefixed public ID) so the browser never needs the
 * service's internal host/port directly.
 */
export async function GET(
  ...
  try {
    ...
    console.error('MusicGen audio proxy error:', error);
