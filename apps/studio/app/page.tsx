      ...
      <header className="sticky top-0 z-50 border-b border-cyan-500/20 bg-black/80 backdrop-blur-lg">
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            <div className="w-10 h-10 bg-gradient-to-br from-cyan-400 to-blue-500 rounded flex items-center justify-center font-bold text-black">
              W2
            </div>
          ...
          <div className="flex items-center gap-4">
            <button className="px-6 py-2 text-sm font-semibold border border-cyan-500/50 hover:bg-cyan-500/10 transition rounded">
              LOGIN
            </button>
            <button className="px-6 py-2 text-sm font-semibold bg-cyan-500 hover:bg-cyan-400 text-black transition rounded">
              START FREE
            </button>
          </div>
        </div>
        ...
        <div className="relative z-10 max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <div className="flex flex-col sm:flex-row gap-4 mb-8">
              <button className="px-8 py-4 bg-cyan-500 hover:bg-cyan-400 text-black font-bold rounded transition transform hover:scale-105 flex items-center justify-center gap-2">
                START FREE TODAY
                <span>→</span>
              </button>
              <button className="px-8 py-4 border-2 border-cyan-500/50 hover:bg-cyan-500/10 font-bold rounded transition flex items-center justify-center gap-2">
                <span>▶</span>
                WATCH DEMO
              </button>
            </div>
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {[
            ...
            <div key={i} className="group">
              <div className="bg-gradient-to-br from-cyan-500/10 to-blue-500/10 border border-cyan-500/20 rounded-lg p-6 backdrop-blur hover:border-cyan-500/50 transition">
                <div className="text-4xl mb-4">{feature.icon}</div>
                <h3 className="font-bold text-lg group-hover:text-cyan-400 transition">{feature.title}</h3>
              </div>
            </div>
          ))}
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              <a key={i} href={product.link} className="group relative">
                ...
                <div className="relative bg-black/50 border border-cyan-500/20 rounded-lg p-6 backdrop-blur hover:border-cyan-500/50 transition h-full">
                  <div className="text-4xl mb-4">{product.icon}</div>
                  <h3 className="font-bold text-sm uppercase tracking-wide mb-2 group-hover:text-cyan-400 transition">{product.title}</h3>
                  <p className="text-sm text-gray-400 mb-4">{product.description}</p>
                  <span className="text-xs font-bold text-cyan-400 hover:text-cyan-300 transition flex items-center gap-1">
                    Learn More →
                  </span>
                </div>
              </a>
          ...
          <div className="grid grid-cols-1 md:grid-cols-5 gap-8 mb-8">
            <div>
              <div className="flex items-center gap-2 mb-4">
                <div className="w-8 h-8 bg-gradient-to-br from-cyan-400 to-blue-500 rounded flex items-center justify-center font-bold text-black text-sm">
                  W2
                </div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-xs text-gray-400">
                <li><a href="#" className="hover:text-cyan-400 transition">AI Command Center</a></li>
                <li><a href="#" className="hover:text-cyan-400 transition">SoundLab</a></li>
                <li><a href="#" className="hover:text-cyan-400 transition">Live Studio</a></li>
                <li><a href="#" className="hover:text-cyan-400 transition">Drop Shipping AI</a></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-xs text-gray-400">
                <li><a href="#" className="hover:text-cyan-400 transition">For Businesses</a></li>
                <li><a href="#" className="hover:text-cyan-400 transition">For Creators</a></li>
                <li><a href="#" className="hover:text-cyan-400 transition">For Agencies</a></li>
                <li><a href="#" className="hover:text-cyan-400 transition">For Developers</a></li>
              </ul>
            </div>
